...
alias edit_spaceship_theme_atom="atom /usr/local/lib/node_modules/spaceship-zsh-theme/spaceship.zsh"
alias yb="yarn build"
...
alias customize_spaceship_template="atom ~/Documents/Development/productivity/bash_overwrites_zsh.sh"
